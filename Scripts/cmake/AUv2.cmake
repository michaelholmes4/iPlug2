...
function(iplug_configure_auv2 target project_name)
  ...
  if(APPLE)
    ...
    if(NOT XCODE)
      ...
      # strict codesign verification (e.g. Gatekeeper/AudioComponent validation)
      # rejects the bundle.
      add_custom_command(TARGET ${target} POST_BUILD
        COMMAND codesign --force --deep --sign - "${CMAKE_BINARY_DIR}/out/${project_name}.component"
        COMMENT "Ad-hoc codesigning ${project_name}.component"
      )
    endif()
  endif()
endfunction()
